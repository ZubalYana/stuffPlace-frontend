            ...
            <div className="z-20 relative">
                ...
                <div className="w-full h-[450px] rounded-2xl flex flex-col items-center bg-[rgba(255, 255, 255, 0.5)] backdrop-blur-md px-6 py-6 mt-6">
                    ...
                    <div className="flex items-center gap-8 mt-12">
                        ...
                        <div className="w-[280px] h-18 flex justify-center items-center rounded-2xl bg-[#AE7461] gap-3 cursor-pointer">
                            <Handshake color="white" size={28} strokeWidth={2.5} />
                            <h3 className="uppercase text-white font-bold text-[24px]">Partnership</h3>
                        </div>

                        <div className="w-[300px] h-18 flex justify-center items-center rounded-2xl border-[#1E1E1E] border-2 gap-3 cursor-pointer">
