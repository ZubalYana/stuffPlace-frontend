    ...
    return (
        <div className="w-full h-screen p-4 xl:p-10">
            <div className="z-20 relative">
                <Header />
                <div className="w-full h-[435px] xs:max-sm:h-[415px] md:max-lg:h-[570px] lg:h-[450px] rounded-2xl flex flex-col items-center bg-[rgba(255, 255, 255, 0.5)] backdrop-blur-md p-4 md:p-6 mt-6">
                    <div className="absolute inset-0 bg-white/30 rounded-2xl pointer-events-none z-0"></div>

                    <h1 className="w-full text-[24px] xs:text-[27px] md:text-[64px] md:w-[90%] xl:w-[60%] xl:text-[64px] text-center font-bold text-[#1E1E1E] leading-[1.2] relative z-20">Strategic Location and Modern Living in <span className="text-[#AE7461]">Budapest</span></h1>
                    <div className="w-full flex flex-col items-center mt-3 relative z-20">
                        <p className="text-[12px] xs:text-[13px] w-full md:text-[16px] font-light md:w-[85%] lg:w-[65%] text-center"><span className="font-semibold">StaffPlace</span> offers contemporary accommodation for individual residents and corporate teams in the heart of Budapest.</p>

                        <p className="text-[12px] xs:text-[13px] w-full md:text-[16px] font-light md:w-[85%] lg:w-[65%] text-center mt-2">
