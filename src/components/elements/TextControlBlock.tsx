...
export const TextControlBlock = () => {
	...
	const [aboutText, setAboutText] = useState<HighlightedLocalizedText>({
		en: { text: '', highlights: [], highlightsInput: '' },
		hu: { text: '', highlights: [], highlightsInput: '' },
	})
	const [advantagesText, setAdvantagesText] = useState<LocalizedText>({
		en: '',
		hu: '',
	})
	const [unitsText, setUnitsText] = useState<LocalizedText>({ en: '', hu: '' })
	const [facilitiesText, setFacilitiesText] = useState<LocalizedText>({
		en: '',
		hu: '',
	})
	const [footerSubtext, setFooterSubtext] = useState<LocalizedText>({
		en: '',
		hu: '',
	})
				...
				<div className='w-full md:w-[48%]'>
					<div className='space-y-3'>
						<TextField
							...
							helperText={`${mainDescription[lang].text.length}/400`}
							fullWidth
						/>
						<TextField
					...
					<div className='space-y-3 mt-6'>
						<TextField
							...
							helperText={`${aboutText[lang].text.length}/700`}
							fullWidth
						/>
						<TextField
					...
					{[
						...
						<div key={label} className='space-y-2 mb-3'>
							<TextField
								...
								helperText={`${state[lang].length}/${max}`}
								fullWidth
							/>
						</div>
					))}
