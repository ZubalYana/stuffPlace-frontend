...
export function FacilityCard({ icon, title, description, index }: FacilityCardProps) {
    return (
        <div className={`w-full md:w-[260px] md:h-[155px] lg:w-[170px] lg:h-[155px] xl:w-[260px] xl:h-[155px] rounded-xl bg-[#AE7461] text-[#F5F5F5] p-4 shadow-xl ${index % 2 == 1 ? 'lg:mt-6' : ''} hover:scale-103 hover:shadow-2xl transition duration-300`}>
